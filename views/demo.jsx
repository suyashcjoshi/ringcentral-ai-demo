...
import sendMail from './button-mail-to.jsx';
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <h2 className="base--h2">Transcribe Audio (RingCentral & IBM Watson)</h2>
        ...
        <div className="flex setup">
          ...
          <div className="column">
            ...
            <p>Complaince Keywords to flag: <input
            ...
            <a href={"mailto:" + "1057998913538@44466177.mvp.ringcentral.com"}>Notify</a>
  </Button>
          </div>
        </div>
        ...
        <div className="flex buttons">
          ...
          <button type="button" className={micButtonClass} onClick={this.handleMicClick}>
            <Icon type={audioSource === 'mic' ? 'stop' : 'microphone'} fill={micIconFill} /> Mic Recording Test
          </button>
          ...
          <button type="button" className={buttonClass} onClick={this.handleSample1Click}>
            <Icon type={audioSource === 'sample-1' ? 'stop' : 'play'} /> Sample Call
          </button>

          <button type="button" className={buttonClass} onClick={this.handleSample2Click}>
            <Icon type={audioSource === 'sample-2' ? 'stop' : 'play'} /> RC Video
          </button>
